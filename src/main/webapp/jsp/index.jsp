...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>LeafSoft-School Management</title>
    <!--REQUIRED STYLE SHEETS-->
    <!-- BOOTSTRAP CORE STYLE CSS -->
    <link href="/school/home_resources/css/bootstrap.css" rel="stylesheet" />
    <!-- FONTAWESOME STYLE CSS -->
    <link href="/school/home_resources/css/font-awesome.min.css" rel="stylesheet" />
    <!--ANIMATED FONTAWESOME STYLE CSS -->
    <link href="/school/home_resources/css/font-awesome-animation.css" rel="stylesheet" />
       <!-- CUSTOM STYLE CSS -->
    <link href="/school/home_resources/css/style.css" rel="stylesheet" />
    <!-- GOOGLE FONT -->
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">LeafSoft</a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="html/index.html">ACCESSAPP</a></li>
                </ul>
            </div>
...
Lorem ipsum dolor sit amet, accumsan.  posuere lectus et, fringilla augue.
 ...
 <i>Address: </i>Karaikudi City, India
    ...
    <!-- CORE JQUERY  -->
    <script src="/school/home_resources/plugins/jquery-1.10.2.js"></script>
    <!-- BOOTSTRAP CORE SCRIPT   -->
    <script src="/school/home_resources/plugins/bootstrap.js"></script>
  
    <!-- CUSTOM SCRIPTS -->
    <script src="/school/home_resources/js/custom.js"></script>
